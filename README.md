<h1> Portfolio_Projects </h1>
A collection of small projects I have done.

<h2> Effectiveness of Marketing Campaigns </h2>
...
Visualisation:
<img src="Marketing Performance.png">
...
<p>
This was a small Tableau project I did during my internship.
  
I was tasked with anaysising the performance of select account managers from the last calander year. I used Tableau to visual the profits over time. 

I was to highlight the performance trend of each account manager and compare them to one another. This allowed the sales managers to determine which account manager was able to out perform the market's dip.

Visualisation:
<img src="Account Manager Performance.png">
